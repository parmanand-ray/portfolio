...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "parmanand.raay@gmail.com",
...

  {
    icon: Phone,
    label: "Phone",
    value: "(+91) 829-495-2890",
    href: "tel:+918294952890",
  },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!serviceId || !templateId || !publicKey) {
        throw new Error(
          "Email js configuration is missing please check your environment variables",
        );
      }
      await emailjs.send(
        serviceId,
      ...
      setSubmitStatus({
        type: "success",
        message: "Message send Successfully! I'll get bact to you soon. ",
      });
